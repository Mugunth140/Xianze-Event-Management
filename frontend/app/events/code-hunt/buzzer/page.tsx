...
export default function CodeHuntBuzzerPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-900 via-teal-900 to-slate-900 flex flex-col">
      {/* Header */}
      <header className="p-4 text-center">
        <h1 className="text-2xl font-bold text-white">Code Hunt</h1>
        <p className="text-emerald-200 text-sm">Buzzer Round</p>
      </header>
        ...
        {state === 'register' && (
          <div className="w-full max-w-sm space-y-6">
            ...
            <div className="space-y-4">
              <div>
                <label className="block text-emerald-200 text-sm mb-2">Team Member 1</label>
                <input
                  type="text"
                  value={name1}
                  onChange={(e) => setName1(e.target.value)}
                  placeholder="Enter first name"
                  className="w-full px-4 py-3 bg-white/10 border border-emerald-500/30 rounded-xl text-white placeholder-emerald-300/50 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent"
                  maxLength={50}
                />
              </div>
              <div>
                <label className="block text-emerald-200 text-sm mb-2">Team Member 2</label>
                <input
                  type="text"
                  value={name2}
            ...
            <button
              ...
              className="w-full py-4 bg-emerald-600 hover:bg-emerald-500 disabled:bg-gray-600 disabled:cursor-not-allowed text-white rounded-xl font-semibold text-lg transition-colors"
            >
              Join Buzzer
            </button>
          </div>
        ...
        {state === 'waiting' && (
          <div className="text-center space-y-6">
            ...
            <div>
              ...
              <p className="text-emerald-200">{message || 'Waiting for coordinator...'}</p>
            </div>
        ...
        {state === 'locked' && (
          <div className="text-center space-y-6">
            ...
            <div>
              ...
              <p className="text-emerald-200">{message || `${winnerNames} pressed first!`}</p>
            </div>
            <p className="text-emerald-400 text-sm">Wait for the next question...</p>
          </div>
        )}
      </main>

      {/* Footer */}
      <footer className="p-4 text-center text-emerald-300/50 text-xs">
        XIANZE 2026 • Code Hunt
      </footer>
    </div>
  );
}
