                ...
                >
                    ...
                    <div className="absolute inset-0 opacity-50 pointer-events-none">
                        <div
                            ...
                            style={{
                                background: 'radial-gradient(ellipse, rgba(109, 64, 212, 0.08) 0%, transparent 70%)'
                            }}
                        />
                    </div>
                    ...
                    <div className="relative z-10">
                        ...
                        <p className="text-lg text-gray-600 max-w-lg mx-auto mb-8">
                            Stay updated with the latest announcements, event schedules, and connect with
                            fellow participants. Be part of the XIANZE family!
                        </p>
                        ...
                        <a
                            ...
                            className="inline-flex items-center gap-3 px-8 py-4 bg-green-500 text-white font-semibold rounded-full shadow-lg shadow-green-500/30 hover:bg-green-600 hover:shadow-xl hover:-translate-y-1 transition-all duration-300"
                        >
                            <svg
                                className="w-5 h-5"
                                fill="currentColor"
