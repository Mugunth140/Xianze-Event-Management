...
const events: EventCard[] = [
  {
    ...
    category: 'Coding',
    description:
      'Test your programming skills in our intense coding competition. Solve algorithmic challenges and compete for glory.',
    icon: '💻',
  ...
  },
  {
    ...
    category: 'Design',
    description:
      'Unleash your creativity in the ultimate design battle. Create stunning visuals and innovative UI/UX solutions.',
    icon: '🎨',
  ...
  },
  {
    ...
    category: 'Knowledge',
    description:
      'Put your tech knowledge to the test. From programming fundamentals to cutting-edge technologies.',
    icon: '🧠',
