            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="max-w-3xl mx-auto text-center">
                    ...
                    >
                        ...
                        <span className="text-primary-600">Competition</span>
                    </h2>
                    ...
                    >
                        XIANZE 2K26 is the premier inter-collegiate tech symposium bringing together
                        the brightest minds from across campuses. Experience a day packed with coding
                        challenges, design battles, innovative workshops, and exciting prizes.
                    </p>
                </div>
