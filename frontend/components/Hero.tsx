            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-start">
                    ...
                    <div>
                        ...
                        >
                            Unleash Your{' '}
                            <span className="text-primary-600">Tech Skills</span>
                            {' '}at XIANZE 2K26.
                        </h1>
                    ...
                    <div className="lg:pt-8">
                        <p
                            ref={descriptionRef}
                            className="text-lg text-gray-600 leading-relaxed opacity-0"
                        >
                            Join the ultimate inter-collegiate tech symposium. Compete, collaborate,
                            and showcase your skills across coding, design, and innovation challenges.
                ...
                <div
                    ref={videoRef}
                    className="mt-16 lg:mt-20 opacity-0"
                >
