...
const faqs: FAQItem[] = [
    {
        ...
        answer: "Xianze is an inter-college technical event where students showcase their skills in various competitions and workshops. It's where innovation meets fun! 🚀",
        emoji: "🎯",
    },
    {
        question: "How can I register?",
        answer: "You can register online through our official website. Just hit that Register button and you're set! Quick and easy.",
        emoji: "📝",
    },
    {
        question: "Is there a cash prize for winners?",
        answer: "Yes! Winners of competitions can win cash prizes of up to ₹20,000 along with certificates and other exciting rewards. Time to flex! 💰",
        emoji: "🏆",
    },
    {
        question: "Is food provided?",
        answer: "Absolutely! Lunch will be provided for participants from other colleges. We've got your belly covered! 🍕",
        emoji: "🍔",
    },
    {
        question: "Who can participate?",
        answer: "Anyone with an interest in technology and innovation can participate. Doesn't matter if you're a pro or just starting — everyone's welcome!",
        emoji: "👥",
    },
    {
        question: "Will I get a certificate?",
        answer: "Yes! All participants will receive certificates, and winners will get special recognition and prizes. Proof of your awesomeness! 📜",
        emoji: "🎖️",
    },
];
...
export default function Faqs() {
    ...
    return (
        ...
        >
            {/* Decorative blobs */}
            <div className="fixed top-20 left-10 w-72 h-72 rounded-full opacity-40 pointer-events-none"
                style={{
                    background: 'radial-gradient(circle, rgba(109, 64, 212, 0.2) 0%, transparent 70%)',
                    filter: 'blur(60px)'
                }}
            />
            <div className="fixed bottom-20 right-10 w-96 h-96 rounded-full opacity-30 pointer-events-none"
                style={{
                ...
                <div ref={headerRef} className="text-center mb-16">
                    ...
                    <h1 className="text-4xl sm:text-5xl lg:text-6xl font-display font-bold text-gray-900 mb-4">
                        ...
                        <span className="relative inline-block">
                            ...
                            <span
                                className="absolute bottom-1 left-0 w-full h-3 bg-primary-200/60 -rotate-1 -z-0"
                            />
                        </span>
                        ! 🎉
                    </h1>
                    ...
                    <p className="text-lg text-gray-600 max-w-lg mx-auto">
                        Everything you need to know about XIANZE 2K26.
                        Can't find what you're looking for? Hit us up!
                    </p>
                </div>
